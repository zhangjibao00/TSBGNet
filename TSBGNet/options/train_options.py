...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--niter', type=int, default=245000, help='# of iter with initial learning rate')
        parser.add_argument('--niter_decay', type=int, default=240000, help='# of iter to decay learning rate to zero')

...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--model', type=str, default='TSBGNet', help='name of the model type. [pluralistic]')
        ...
        # data pattern define
        parser.add_argument('--img_file', type=str, default='', help='training and testing dataset')
        parser.add_argument('--mask_file', type=str, default='', help='load test mask')
